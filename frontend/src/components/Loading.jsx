...
export const FetchDataLoading = () => {
  return (
    <div className=" absolute  left-0 top-0 w-full h-full flex rounded-sm items-center justify-center ">
      <div className=" py-2 w-10 h-10 animate-[spin_1s_linear_infinite] rounded-full border-4 border-r-[#17DB4F] border-[#ececec] "></div>
    </div>
  );
};