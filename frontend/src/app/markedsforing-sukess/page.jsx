  ...
  return (
    <div className="min-h-[100vh] px-3 pt-[170px] flex items-center">
      ...
      >
        ...
        >
          Takk! Vi har mottatt forespørselen din for markedsføringstjenesten!
        </motion.h2>
        ...
        >
          Takk for at du valgte <strong>{planName}</strong>-pakken til{" "}
          <strong>{price} NOK</strong>. Vi har mottatt forespørselen din og vil
          ta kontakt med deg så snart som mulig for å starte prosessen.
        </motion.p>
