...
const Hero = () => {
  return (
    <div className=" relative h-[700px] lg:h-[750px] max-w-[1400px]  mx-auto text-white flex flex-col lg:flex-row  lg:justify-between ">
      <div
        className="  flex  
      mt-[170px]  flex-col z-50  px-3 max-w-[40rem] lg:max-w-[50rem] "
      >
        ...
        <div className="mt-5">
          <Link
            href="/nettside"
            className="border-2 px-2 md:px-0 whitespace-none md:whitespace-normal rounded w-[215px] md:w-[250px] lg:w-[300px] justify-center text-sm lg:text-lg font-medium flex items-center gap-1 md:gap-2 border-white p-1 md:p-2 transition-transform transform hover:scale-x-105 hover:origin-left group"
          >
