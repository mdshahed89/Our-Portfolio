...
const OfferSection = () => {
  ...
  return (
    <div className=" px-1 md:px-3 -mt-24 lg:-mt-40 lg:px-0 max-w-[1600px] mx-auto">
      <div>
        <h2 className="font-semibold px-4 py-3 text-[40px]">Hva vi tilbyr</h2>
      </div>
      <div className=" gap-5 grid lg:grid-cols-3 grid-cols-1 ">
        <div className={` md:p-3 p-2 lg:p-5 rounded-sm lg:max-w-[520px] bg-[#7BDCB5]`}>
          <h2 className="text-[34px]  pb-5 font-semibold">Nettside</h2>
          <div className="lg:min-h-[180px]">
            <div
              className={`text-xl flex flex-col gap-6 text-gray-800 leading-tight whitespace-pre-line`}
            >
              <p className=" italic ">
          ...
          <div className="flex justify-center my-3 mt-7 lg:mt-12">
            <Link
              href={"/nettside"}
        ...
        <div className={`md:p-3 p-2 lg:p-5 lg:max-w-[520px] rounded-sm bg-[#FFD0F9]`}>
        ...
        <div className={`md:p-3 p-2 lg:p-5 lg:max-w-[520px] rounded-sm bg-[#0B2927]`}>
