...
const Tools = () => {
  return (
    <div className="grid lg:grid-cols-5 my-16 max-w-[1440px] mx-auto justify-center lg:justify-between px-5 lg:px-0 gap-5 items-center">
      <div className="flex flex-col  items-center justify-center ">
        <Image src={"/t1.png"} width={80} height={80} />
      ...
      <div className="flex flex-col items-center justify-center ">
        <Image src={"/t2.png"} width={80} height={80} />
        <div className="text-center space-y-2 pt-2">
      ...
      <div className="flex flex-col items-center justify-center ">
        <Image src={"/t3.png"} width={80} height={80} />
        <div className="text-center space-y-2 pt-2">
      ...
      <div className="flex flex-col items-center justify-center ">
        <Image src={"/t4.png"} width={80} height={80} />
        <div className="text-center space-y-2 pt-2">
      ...
      <div className="flex flex-col items-center justify-center ">
        <Image src={"/t5.png"} width={80} height={80} />
        <div className="text-center space-y-2 pt-2">
